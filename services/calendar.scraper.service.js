...
export const HtmlFetcher = async (year, month) => {
  ...
  try {
    ...
    const calendarElements = document.querySelectorAll('.cssDays1, .cssPost_day1, .cssSaturdays1');
    console.log(`URL: ${url} - Found ${calendarElements.length} calendar elements`);
